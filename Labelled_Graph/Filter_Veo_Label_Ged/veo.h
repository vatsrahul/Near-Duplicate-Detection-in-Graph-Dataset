...
public:
    ...
    bool VertexLabelFilter(Graph &g2, Graph &g1, int index2, int index1, unordered_set<unsigned>& v_label, unordered_set<unsigned>& e_label, long unsigned &VertexLabelFilterCount, double threshold);
    bool EdgeLabelFilter(Graph &g2, Graph &g1, int index2, int index1, unordered_set<unsigned>& v_label, unordered_set<unsigned>& e_label, long unsigned &EdgeLabelFilterCount, double threshold);
