...
Compiling this code:
$ g++ -std=c++14 filter.cpp veo.cpp graph.cpp Gsim/astar1.cpp Gsim/filter1.cpp Gsim/graph1.cpp Gsim/GED.cpp Gsim/misc1.cpp Gsim/path_join1.cpp Gsim/path_search1.cpp Gsim/set_cover1.cpp -o filter
