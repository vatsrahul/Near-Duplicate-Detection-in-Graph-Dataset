...
$ g++ -std=c++11 generate_pageranks.cpp graph.cpp -o generate_pagerank $(/usr/bin/python3.6-config --ldflags)

Running the code:
$ ./generate_pagerank graph-dataset-file pagerank-filename

For Example:
$ ./generate_pagerank ./dataset/data_file_sorted.txt ./dataset/pageranks_data_file.txt
