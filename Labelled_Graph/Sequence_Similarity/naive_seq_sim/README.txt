** Changes i am making**
1. sorting based on label
2. walk alg based on vertex_id  (as we need unique vertexes) BUT STORED LABELS IN "WALK" WHICH WERE USED IN hashing 
3. shingle gen based on "WALK" which is labels only  
