...
bool is_adjacent( Graph1 &g, const int uid, const int vid )
{
...
bool is_adjacent_with_label( Graph1 &g, const int uid, const int vid, const int label )
{
	for (unsigned i = 0; i < g[uid].degree; ++ i)
...
int estimate_vertex( Graph1 &g1, Graph1 &g2, vector<int> &vertex_mapping_g1, vector<int> &vertex_mapping_g2 )
{
...
void process_label_list( Graph1 &g, vector<int> &vlabel_list, vector<int> &elabel_list, vector<int> &vid_to_vlabel_list, vector< vector<int> > &eid_to_elabel_list )
{
	int i, j;
...
void copy_label_list( Graph1 &g, vector<int> &vlabel_list, vector<int> &elabel_list, vector<int> &vid_to_vlabel_list, vector< vector<int> > &eid_to_elabel_list )
{
...
int compute_mismatch_error( GED_node& next_node, const unsigned lgid, const unsigned rgid, const int threshold )
{
	int m, n;
	bool found;
	Graph1 &lg = gdb[lgid], &rg = gdb[rgid];
